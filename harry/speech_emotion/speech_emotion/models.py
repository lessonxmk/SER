...
from keras.layers import Conv1D, MaxPool1D, Dense, Dropout, Flatten, LSTM, Conv2D, MaxPool2D
...
class KerasModel(object):
    ...
    def train(self, train_X, train_y, valid_X, valid_y, n_class, model_path, class_names):
        ...
        # train_X = np.transpose(train_X, (0, 1, 3, 2))
        # valid_X = np.transpose(valid_X, (0, 1, 3, 2))
    ...
    def _build_model_1dcnn(d, n_class):
        ...
        # model.add(Conv2D(64, 3, padding='same', activation='relu', input_shape=(13, 63, 1)))
